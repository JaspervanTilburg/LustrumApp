...
public class TijdlijnTabFragment extends Fragment {
    ...
    public void initButtons() {
        ...
        LustrumButton piekWekenInfoButton = new LustrumButton((ImageView) rootView.findViewById(R.id.piekWekenInfoButton), R.color.lustrumPink, width*0.76f, height*0.82f);
